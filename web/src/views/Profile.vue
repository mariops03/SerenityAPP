  ...
  <v-container class="fill-height">
    <v-row justify="center" align="center">
      <v-col cols="12" md="10" lg="8">
        <v-card class="profile-container" outlined>
          <v-row align="center">
            <v-col cols="12" sm="6">
              <v-img :src="user.photo" class="profile-photo"></v-img>
            </v-col>
            <v-col cols="12" sm="6">
              ...
              <v-btn color="#4ABDFD" class="mx-9 my-2" @click="changeSubscriptionPlan">CERRAR SESIÓN</v-btn>
            </v-col>
          </v-row>
          <v-row justify="end">
...
export default {
  ...
  methods: {
    ...
    changeSubscriptionPlan() {
      // POR IMPLEMENTAR
      console.log("Cambiando plan de suscripción...");
    }
  }
}
</script>
